# Quarantined legacy Python/Node container definition.
#
# The active repo build target is the Gleam/Erlang Hermes BEAM app under
# hermes_beam/. Keep this file only as a historical reference for the former
# Python/Node hermes-agent image; do not use it as the default Docker build.
# The root Dockerfile and docker/hermes-beam.Dockerfile are the minimal BEAM
# container path.
